...
} from '../../comment/comment.data.models';

export const getPostViewModel = async (
  post: PostModelWithLikeData | PostDbModel | null,
...
export const getArrayOfPostsViewModels = async (
  posts: PostModelWithLikeData[] | [],
